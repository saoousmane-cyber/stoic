      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1">
          <input
            ...
            placeholder="Rechercher des images (ex: méditation, forêt, statue...)"
      ...
      {images.length > 0 ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mt-2">
            Sources : Pixabay & Pexels • Toutes les images sont libres d'utilisation
          </p>
        </div>
      )}
        ...
        >
          <div className="relative max-w-4xl w-full">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/50 rounded-lg p-2 text-white text-sm">
              ...
              <span>Auteur: {selectedImage.author}</span>
            </div>
            <button
              onClick={() => setSelectedImage(null)}
